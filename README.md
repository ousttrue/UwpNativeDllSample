...
zlib-1.2.11\build> %CMAKE% -G "Visual Studio 15 2017" -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 -DCMAKE_INSTALL_PREFIX=..\..\install .. 
...
libpng-1.6.29\build> %CMAKE% -G "Visual Studio 15 2017" -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 -DZLIB_ROOT=..\..install -DCMAKE_INSTALL_PREFIX=..\..\install .. 
